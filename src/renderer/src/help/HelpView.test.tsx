  ...
  it.each([
    ...
    (_where, modifier, glyph) => {
      ...
      for (const shortcut of BOUND) {
        ...
        // ⌃Tab is Control on every platform, and ⌃⌘↓ leads with Control as Apple orders it; F6 is a key alone.
        const lead = shortcut.chord?.bare
          ? ''
          : shortcut.chord?.ctrl || shortcut.chord?.control
            ? modifier.controlLabel
            : glyph
