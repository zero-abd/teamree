// The frame Settings, Help, Teamwork and All panes share: a head with the title, the page's own controls
// and a ×, then one measured column that scrolls under it.
  ...
  return (
    <main className="workspace page" aria-label={label} tabIndex={-1} ref={region}>
      <header className="page__head">
        <div className="page__column page__head-row">
